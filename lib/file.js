...
internals.prepare = function (response, callback) {
    ...
    Fs.stat(path, function (err, stat) {
        ...
        if (response.request.server._core._etags) {
            ...
            var cachedEtag = response.request.server._core._etags.get(cachekey);
            if (cachedEtag) {
                ...
                response.once('finish', function () {
                    ...
                    response.request.server._core._etags.set(cachekey, etag);
                });
            }
        }
