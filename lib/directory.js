...
internals.renderSimpleListing = function (request, context, next) {
...
internals.renderListing = function (request, context, renderFn, callback) {

    callback = Hoek.nextTick(callback);

    try {
        return renderFn(request, context, callback);
    }
    catch (ex) {
        return callback(ex);
    }
...
internals.generateListing = function (path, resource, selection, hasTrailingSlash, settings, request, reply) {
    ...
    Fs.readdir(path, (err, files) => {
        ...
        internals.renderListing(request, context, renderFn, (err, rendered, type, charset) => {
